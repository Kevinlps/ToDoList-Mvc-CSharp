...
namespace ToDoList.Controllers
{
    public class TarefasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Titulo,Concluida")] Tarefa tarefa)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Titulo,Concluida")] Tarefa tarefa)
        {
            if (id != tarefa.Id)
            {
                return NotFound();
